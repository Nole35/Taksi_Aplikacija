...
public class IstorijaVozacaA extends JFrame {
	...
	public IstorijaVozacaA(TaksiSluzba taksiSluzba, TaksiSluzbai taksiSluzbai,Vozaci vozac) {
		setTitle("Istorija voznji vozaca " + vozac.getKorisnickoIme());
		...
		for(int i=0; i<taksiSluzba.sveNeobrisaneVoznjeA().size(); i++) {
			...
			if(voznja.getVozacId() == vozac.getId()) {
